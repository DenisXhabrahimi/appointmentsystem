    ...
    <div class="row center">
        ...
        <form action="<?php echo e(route('business_hours.update')); ?>" method="post">
            ...
            <div class="input-field col s3">
                <p>
                    <label>
                        <input value="true" name="data[<?php echo e($businessHour->day); ?>][off]" class="filled-in" type="checkbox" <?php if($businessHour->off): echo 'checked'; endif; ?> />
                        <span>OFF</span>
                    </label>
                </p>
            </div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appointmentsystem\example-app\resources\views/welcome.blade.php ENDPATH**/ ?>